...
module.exports = async (req, res) => {
    ...
    try {
        ...
        // 2. Have incomplete profiles (missing key fields OR no guardians)
        ...
        for (const user of users) {
            try {
                // Send first test email to info@vgdanismanlik.com
                if (sentCount === 0 && req.query.test === 'true') {
                    console.log(`📧 [TEST] Sending test reminder to info@vgdanismanlik.com for user: ${user.email}`);
